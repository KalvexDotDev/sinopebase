...
const singularRules: SingularRule[] = [
  ...
  { pattern: "(?i)(alumn|bacill|cact|foc|fung|nucle|radi|stimul|syllab|termin|viri?)i$", replacement: "$1us" },
  ...
  { pattern: "(?i)(analy|diagno|^ba|(p)arenthe|(p)rogno|(s)ynop|(t)he)ses$", replacement: "$1$2sis" },
