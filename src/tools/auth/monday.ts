/**
 * Monday OAuth2 provider (stub).
 *
 * Port of github.com/pocketbase/pocketbase/tree/master/tools/auth/monday.go
 ...
 *   - User:  https://api.monday.com/v2/users/me
 *
 * Default scopes: none
 */
...
/**
 * MondayProvider implements OAuth2 authentication via Monday.
 *
...
export class MondayProvider extends BaseProvider {
  constructor(clientId: string, clientSecret: string, redirectUrl: string) {
    super(
      ...
      'https://api.monday.com/v2/users/me',
      [],
    )
  }
