/**
 * Vk OAuth2 provider (stub).
 *
 * Port of github.com/pocketbase/pocketbase/tree/master/tools/auth/vk.go
...
/**
 * VkProvider implements OAuth2 authentication via Vk.
 *
